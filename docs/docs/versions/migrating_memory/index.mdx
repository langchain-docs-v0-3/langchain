...
As of the v0.3 release of LangChain, we recommend that LangChain users take advantage of [LangGraph persistence](https://langchain-docs-v0-3.github.io/langgraph/concepts/persistence/) to incorporate `memory` into their LangChain application.
...
As of LangChain v0.1, we started recommending that users rely primarily on [BaseChatMessageHistory](https://langchain-docs-v0-3.github.io/api_reference/core/runnables/langchain_core.runnables.history.RunnableWithMessageHistory.html#langchain_core.runnables.history.RunnableWithMessageHistory). `BaseChatMessageHistory` serves
as a simple persistence for storing and retrieving messages in a conversation.

At that time, the only option for orchestrating LangChain chains was via [LCEL](https://langchain-docs-v0-3.github.io/langchain/docs/how_to/#langchain-expression-language-lcel). To incorporate memory with `LCEL`, users had to use the [RunnableWithMessageHistory](https://langchain-docs-v0-3.github.io/api_reference/core/runnables/langchain_core.runnables.history.RunnableWithMessageHistory.html#langchain_core.runnables.history.RunnableWithMessageHistory) interface. While sufficient for basic chat applications, many users found the API unintuitive and challenging to use.

As of LangChain v0.3, we recommend that **new** code takes advantage of LangGraph for both orchestration and persistence:

- Orchestration: In LangGraph, users define [graphs](https://langchain-docs-v0-3.github.io/langgraph/concepts/low_level/) that specify the flow of the application. This allows users to keep using `LCEL` within individual nodes when `LCEL` is needed, while making it easy to define complex orchestration logic that is more readable and maintainable.
- Persistence: Users can rely on LangGraph's [persistence](https://langchain-docs-v0-3.github.io/langgraph/concepts/persistence/) to store and retrieve data. LangGraph persistence is extremely flexible and can support a much wider range of use cases than the `RunnableWithMessageHistory` interface.
...
- [LangGraph](https://langchain-docs-v0-3.github.io/langgraph/)
- [v0.0.x Memory](https://langchain-docs-v0-3.github.io/langchain/v0.1/docs/modules/memory/)
- [How to add persistence ("memory") to your graph](https://langchain-docs-v0-3.github.io/langgraph/how-tos/persistence/)
:::
...
* [LangGraph quickstart tutorial](https://langchain-docs-v0-3.github.io/langgraph/tutorials/introduction/)
* [How to add persistence ("memory") to your graph](https://langchain-docs-v0-3.github.io/langgraph/how-tos/persistence/)
* [How to manage conversation history](https://langchain-docs-v0-3.github.io/langgraph/how-tos/memory/manage-conversation-history/)
* [How to add summary of the conversation history](https://langchain-docs-v0-3.github.io/langgraph/how-tos/memory/add-summary-conversation-history/)

Add persistence with simple LCEL (favor langgraph for more complex use cases):

* [How to add message history](https://langchain-docs-v0-3.github.io/langchain/docs/how_to/message_history/)

Working with message history:

* [How to trim messages](https://langchain-docs-v0-3.github.io/langchain/docs/how_to/trim_messages)
* [How to filter messages](https://langchain-docs-v0-3.github.io/langchain/docs/how_to/filter_messages/)
* [How to merge message runs](https://langchain-docs-v0-3.github.io/langchain/docs/how_to/merge_message_runs/)
