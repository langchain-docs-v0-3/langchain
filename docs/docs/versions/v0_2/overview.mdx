...
- Better streaming support via the [Event Streaming API](https://langchain-docs-v0-3.github.io/langchain/docs/expression_language/streaming/#using-stream-events).
...
- [@chain decorator](https://langchain-docs-v0-3.github.io/langchain/docs/expression_language/how_to/decorator/) to more easily create **RunnableLambdas**
- https://langchain-docs-v0-3.github.io/langchain/docs/expression_language/how_to/inspect/
...
- Tooling to visualize [your runnables](https://langchain-docs-v0-3.github.io/langchain/docs/expression_language/how_to/inspect/) or [your langgraph app](https://github.com/langchain-ai/langgraph/blob/main/examples/visualization.ipynb)
- Interoperability of chat message histories across most providers
- [Over 20+ partner packages in python](https://langchain-docs-v0-3.github.io/langchain/docs/integrations/providers/) for popular integrations


## What’s coming to LangChain?

- We’ve been working hard on [langgraph](https://langchain-docs-v0-3.github.io/langgraph/). We will be building more capabilities on top of it and focusing on making it the go-to framework for agent architectures.
