...
* A list of built-in `Runnables` can be found in the [LangChain Core API Reference](https://langchain-docs-v0-3.github.io/api_reference/core/runnables.html). Many of these Runnables are useful when composing custom "chains" in LangChain using LCEL.
:::
...
`LCEL` chains are built by composing existing `Runnables` together. The two main composition primitives are [RunnableSequence](https://langchain-docs-v0-3.github.io/api_reference/core/runnables/langchain_core.runnables.base.RunnableSequence.html#langchain_core.runnables.base.RunnableSequence) and [RunnableParallel](https://langchain-docs-v0-3.github.io/api_reference/core/runnables/langchain_core.runnables.base.RunnableParallel.html#langchain_core.runnables.base.RunnableParallel).

Many other composition primitives (e.g., [RunnableAssign](
https://langchain-docs-v0-3.github.io/api_reference/core/runnables/langchain_core.runnables.passthrough.RunnableAssign.html#langchain_core.runnables.passthrough.RunnableAssign
)) can be thought of as variations of these two primitives.

:::note
You can find a list of all composition primitives in the [LangChain Core API Reference](https://langchain-docs-v0-3.github.io/api_reference/core/runnables.html).
:::
