...
2. Output: A list of documents (standardized LangChain [Document](https://langchain-docs-v0-3.github.io/api_reference/core/documents/langchain_core.documents.base.Document.html) objects)
...
In particular, [LangChain's retriever class](https://langchain-docs-v0-3.github.io/api_reference/core/retrievers/langchain_core.retrievers.BaseRetriever.html#) only requires that the `_get_relevant_documents` method is implemented, which takes a `query: str` and returns a list of [Document](https://langchain-docs-v0-3.github.io/api_reference/core/documents/langchain_core.documents.base.Document.html) objects that are most relevant to the query.
...
Retrievers return a list of [Document](https://langchain-docs-v0-3.github.io/api_reference/core/documents/langchain_core.documents.base.Document.html) objects, which have two attributes:
