...
We will use LangChain's [InMemoryVectorStore](https://langchain-docs-v0-3.github.io/api_reference/core/vectorstores/langchain_core.vectorstores.in_memory.InMemoryVectorStore.html) implementation to illustrate the API.
...
This API works with a list of [Document](https://langchain-docs-v0-3.github.io/api_reference/core/documents/langchain_core.documents.base.Document.html) objects.
...
This will take the search query, create an embedding, find similar documents, and return them as a list of [Documents](https://langchain-docs-v0-3.github.io/api_reference/core/documents/langchain_core.documents.base.Document.html).
...
As an example [Pinecone](https://langchain-docs-v0-3.github.io/api_reference/pinecone/vectorstores/langchain_pinecone.vectorstores.PineconeVectorStore.html#langchain_pinecone.vectorstores.PineconeVectorStore.similarity_search) several parameters that are important general concepts:
...
For example, [maximal marginal relevance](https://langchain-docs-v0-3.github.io/langchain/v0.1/docs/modules/model_io/prompts/example_selectors/mmr/) is a re-ranking algorithm used to diversify search results, which is applied after the initial similarity search to ensure a more diverse set of results.
...
| [Maximal Marginal Relevance (MMR)](https://langchain-docs-v0-3.github.io/api_reference/pinecone/vectorstores/langchain_pinecone.vectorstores.PineconeVectorStore.html#langchain_pinecone.vectorstores.PineconeVectorStore.max_marginal_relevance_search) | When needing to diversify search results.             | MMR attempts to diversify the results of a search to avoid returning similar and redundant documents.                                        |
