...
[memory](https://langchain-docs-v0-3.github.io/langgraph/concepts/memory/) in chat models.
:::

## Related resources

- [How to trim messages](/docs/how_to/trim_messages/)
- [Memory guide](https://langchain-docs-v0-3.github.io/langgraph/concepts/memory/) for information on implementing short-term and long-term memory in chat models using [LangGraph](https://langchain-docs-v0-3.github.io/langgraph/).
