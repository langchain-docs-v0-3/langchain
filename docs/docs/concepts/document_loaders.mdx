...
Documents loaders implement the [BaseLoader interface](https://langchain-docs-v0-3.github.io/api_reference/core/document_loaders/langchain_core.document_loaders.base.BaseLoader.html).
...
* [Document API reference](https://langchain-docs-v0-3.github.io/api_reference/core/documents/langchain_core.documents.base.Document.html)
