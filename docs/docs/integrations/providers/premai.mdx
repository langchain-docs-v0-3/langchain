...
- You can learn more about langchain tool calling in [this part of the docs](https://langchain-docs-v0-3.github.io/langchain/v0.1/docs/modules/model_io/chat/function_calling).
