...
> **(Note)** Naver integration via `langchain-community`, a collection of [third-party integrations](https://langchain-docs-v0-3.github.io/langchain/docs/concepts/architecture/#langchain-community), is outdated.
