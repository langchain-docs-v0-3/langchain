...
We recommend the Converse API for users who do not need to use custom models. It can be accessed using [ChatBedrockConverse](https://langchain-docs-v0-3.github.io/api_reference/aws/chat_models/langchain_aws.chat_models.bedrock_converse.ChatBedrockConverse.html).
...
See a [usage example](https://langchain-docs-v0-3.github.io/langchain/v0.1/docs/guides/productionization/safety/amazon_comprehend_chain/).
