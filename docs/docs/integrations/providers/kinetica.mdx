...
The Kinetica Document loader can be used to load LangChain [Documents](https://langchain-docs-v0-3.github.io/api_reference/core/documents/langchain_core.documents.base.Document.html) from the
