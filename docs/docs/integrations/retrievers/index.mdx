...
Retrievers accept a string query as input and return a list of [Documents](https://langchain-docs-v0-3.github.io/api_reference/core/documents/langchain_core.documents.base.Document.html) as output.
