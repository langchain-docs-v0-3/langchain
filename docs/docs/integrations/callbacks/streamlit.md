...
[API reference](https://langchain-docs-v0-3.github.io/api_reference/langchain/callbacks/langchain.callbacks.streamlit.streamlit_callback_handler.StreamlitCallbackHandler.html).
