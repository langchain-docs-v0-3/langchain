...
[unit tests](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/unit_tests/langchain_tests.unit_tests.chat_models.ChatModelUnitTests.html)
and [integration tests](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/integration_tests/langchain_tests.integration_tests.chat_models.ChatModelIntegrationTests.html).
...
- [Unit tests API reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/unit_tests/langchain_tests.unit_tests.chat_models.ChatModelUnitTests.html)
- [Integration tests API reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/integration_tests/langchain_tests.integration_tests.chat_models.ChatModelIntegrationTests.html)
...
For example, below is the `VectorStoreIntegrationTests` class for the [Chroma](https://langchain-docs-v0-3.github.io/langchain/docs/integrations/vectorstores/chroma/)
integration:
...
["fake" embeddings model](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/integration_tests/langchain_tests.integration_tests.vectorstores.VectorStoreIntegrationTests.html#langchain_tests.integration_tests.vectorstores.VectorStoreIntegrationTests.get_embeddings)
...
Details on what tests are run and troubleshooting tips for each test can be found in the [API reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/integration_tests/langchain_tests.integration_tests.vectorstores.VectorStoreIntegrationTests.html).
...
- [Unit tests API reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/unit_tests/langchain_tests.unit_tests.embeddings.EmbeddingsUnitTests.html)
- [Integration tests API reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/integration_tests/langchain_tests.integration_tests.embeddings.EmbeddingsIntegrationTests.html)
...
- [Unit tests API reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/unit_tests/langchain_tests.unit_tests.tools.ToolsUnitTests.html)
- [Integration tests API reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/integration_tests/langchain_tests.integration_tests.tools.ToolsIntegrationTests.html)
...
Details on what tests are run and troubleshooting tips for each test can be found in the [API reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/integration_tests/langchain_tests.integration_tests.retrievers.RetrieversIntegrationTests.html).
...
see the [Standard Tests API Reference](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/index.html).

You can see troubleshooting guides under the individual test suites listed in that API Reference. For example,
[here is the guide for `ChatModelIntegrationTests.test_usage_metadata`](https://langchain-docs-v0-3.github.io/api_reference/standard_tests/integration_tests/langchain_tests.integration_tests.chat_models.ChatModelIntegrationTests.html#langchain_tests.integration_tests.chat_models.ChatModelIntegrationTests.test_usage_metadata).
