...
import ChatModelSource from '../../../../src/theme/integration_template/integration_template/chat_models.py';
    ...
    <TabItem value="vector_stores" label="Vector stores">
        ...
        [in-memory vector store](https://langchain-docs-v0-3.github.io/api_reference/core/vectorstores/langchain_core.vectorstores.in_memory.InMemoryVectorStore.html)
        ...
        All vector stores must inherit from the [VectorStore](https://langchain-docs-v0-3.github.io/api_reference/core/vectorstores/langchain_core.vectorstores.base.VectorStore.html)
        ...
        documents to the store. See the [API Reference](https://langchain-docs-v0-3.github.io/api_reference/core/vectorstores/langchain_core.vectorstores.base.VectorStore.html)
...
The `Tools` class must inherit from the [BaseTool](https://langchain-docs-v0-3.github.io/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool) base class. This interface has 3 properties and 2 methods that should be implemented in a
subclass.
...
response. This method is usually called in a LangGraph [`ToolNode`](https://langchain-docs-v0-3.github.io/langgraph/how-tos/tool-calling/), and can also be called in a legacy
...
based on a query. The `Retriever` class must inherit from the [BaseRetriever](https://langchain-docs-v0-3.github.io/api_reference/core/retrievers/langchain_core.retrievers.BaseRetriever.html) base class. This interface has 1 attribute and 2 methods that should be implemented in a subclass.
